...
void testBlockedPaths() {
  ...
  // Queen combining both directions
  {
    ...
    Bitboard occ = parseBoardPosition("Qd1 Pd4 Pd6");
...
void testNestedBlockers() {
  ...
  // Test multiple blocker ordering
  {
    ...
    simpleBoard.setOccupancy(parseBoardPosition("Ra1 Pb1 Pc1 Pd1"));
...
void testEdgeCases() {
  ...
  {
    PhysicalBoard board;
    board.setOccupancy(parseBoardPosition(
  ...
  {
    PhysicalBoard board;
    board.setOccupancy(parseBoardPosition("Qd1"));
  ...
  {
    PhysicalBoard board;
    board.setOccupancy(parseBoardPosition("Ke1 Rh1"));
  ...
  {
    PhysicalBoard board;
    board.setOccupancy(parseBoardPosition("Ke1 Bf1 Ng1 Rh1"));
